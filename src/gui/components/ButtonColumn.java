        ...
        implements TableCellRenderer, TableCellEditor, ActionListener, MouseListener
{
    ...
    private void setup(JTable table, Action action, int column){
        this.table = table;
        this.action = action;
    ...
    private void setupButton(JButton btn,Object value){
        if (value == null)
        {
            btn.setText( "" );
            btn.setIcon( null );
...
//		renderButton.setText( (value == null) ? "" : value.toString() );
        setupButton(renderButton,value);
